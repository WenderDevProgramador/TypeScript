...
document.getElementById("confirmarRegistrar").addEventListener("click", () => {
    const name = document.getElementById("nomeNave").value;
    const pilot = document.getElementById("pilotoNave").value;
    const crewLimit = Number(document.getElementById("limiteTripulantes").value);
...
document.getElementById("confirmarAdicionar").addEventListener("click", () => {
    const member = document.getElementById("nomeTripulante").value;
    const spaceshipName = document.getElementById("naveDestino").value;
...
document.getElementById("confirmarEnviar").addEventListener("click", () => {
    const spaceshipName = document.getElementById("naveEnviar").value;
    const ship = findSpaceShip(spaceshipName);
    if (ship) {
        sendInMission(ship);
        toggleSection("menu");
