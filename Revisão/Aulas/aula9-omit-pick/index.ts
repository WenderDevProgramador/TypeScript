...
type LocalGithubUser =  Pick <GithubUserResponse, 'login' | 'id' | 'avatar_url' | 'html_url' | 'name' | 'bio' >

type LocalGithubRepo = Pick <GithubRepoResponse, 'name' | 'html_url' | 'description' | 'forks' | 'stargazers_count' >
